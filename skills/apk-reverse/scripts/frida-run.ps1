...
function Get-ToolPath {
    ...
    if (-not $cmd) {
        $fallbacks = @{
            'frida-ls-devices' = @(
                'C:\Users\YOURNAME\AppData\Roaming\Python\Python314\Scripts\frida-ls-devices.exe'
            )
            'frida-ps' = @(
                'C:\Users\YOURNAME\AppData\Roaming\Python\Python314\Scripts\frida-ps.exe'
            )
            'frida' = @(
                'C:\Users\YOURNAME\AppData\Roaming\Python\Python314\Scripts\frida.exe'
            )
        }
