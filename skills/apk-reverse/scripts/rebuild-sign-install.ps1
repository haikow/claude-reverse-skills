...
param(
    ...
    [string]$KeystorePath = 'C:\Users\YOURNAME\.config\opencode\skills\apk-reverse\debug.keystore',
...
function Get-ToolPath {
    ...
    $fallbacks = @{
        'apktool' = @(
            'C:\Users\YOURNAME\Tools\apktool\apktool.bat'
        )
        'zipalign' = @(
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\36.0.0\zipalign.exe',
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\35.0.0\zipalign.exe',
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\34.0.0\zipalign.exe'
        )
        'apksigner' = @(
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\36.0.0\apksigner.bat',
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\35.0.0\apksigner.bat',
            'C:\Users\YOURNAME\AppData\Local\Android\Sdk\build-tools\34.0.0\apksigner.bat'
        )
        'keytool' = @(
