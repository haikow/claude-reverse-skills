...
**调用方式**：
```
powershell -File "C:\Users\YOURNAME\.config\opencode\skills\ida-reverse\scripts\start.ps1"
```
...
**调用方式**：
```
powershell -File "C:\Users\YOURNAME\.config\opencode\skills\ida-reverse\scripts\open.ps1" -Path "C:\path\to\file.exe"
```
